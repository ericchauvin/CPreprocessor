...
public class IncludeDictionary
  {
  private MainApp mApp;
  private IncludeDictionaryLine lineArray[];
  ...
  private IncludeDictionary()
    {
    }



  public IncludeDictionary( MainApp useApp )
    {
    mApp = useApp;
    lineArray = new IncludeDictionaryLine[keySize];
    }
  ...
  public void setValue( StrA key, StrA value )
    ...
    if( lineArray[index] == null )
      lineArray[index] = new IncludeDictionaryLine();
